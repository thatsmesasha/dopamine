...
class ObstacleTowerEnv(gym.Env):
    ...
    def __init__(self, environment_filename=None, docker_training=False, worker_id=0, retro=True,
        ...
        print('424242 brain.vector_action_space_size')
        ...
        print('424242 self._action_space')
...
class ActionFlattener():
    ...
    def _create_lookup(self, branched_action_space):
        ...
        action_lookup[0] = [1,0,0,0]
        action_lookup[1] = [0,1,0,0]
        action_lookup[2] = [0,2,0,0]
        action_lookup[3] = [1,0,1,0]

        print('424242 create_lookup')
        print(branched_action_space)
        print(action_lookup)
